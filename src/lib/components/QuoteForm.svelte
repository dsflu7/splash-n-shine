<script lang="ts">
	...
	const propertyTypes = [
		{ id: 'residential', title: 'Residential', icon: '🏡' },
		{ id: 'commercial', title: 'Commercial', icon: '🏢' },
		{ id: 'multi-unit', title: 'Multi-Unit', icon: '🏘️' }
	];
...
<div class="w-full max-w-4xl mx-auto bg-card border border-border rounded-lg shadow-lg overflow-hidden">
	<!-- Header -->
	...
	{:else}
		...
		{#if showServiceSelection}
			...
			<div>
				<h3 class="text-lg font-semibold text-foreground mb-4 flex items-center">
					<span class="w-6 h-6 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-sm mr-3">1</span>
			...
			<div>
				<h3 class="text-lg font-semibold text-foreground mb-4 flex items-center">
					<span class="w-6 h-6 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-sm mr-3">2</span>
					Property Type
				</h3>
			...
			<div>
				<h3 class="text-lg font-semibold text-foreground mb-4 flex items-center">
					<span class="w-6 h-6 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-sm mr-3">3</span>
		...
		<div>
			<h3 class="text-lg font-semibold text-foreground mb-4 flex items-center">
				<span class="w-6 h-6 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-sm mr-3">{showServiceSelection ? '4' : '1'}</span>
		...
		{#if submitSuccess}
			<div class="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg">
				<strong>Thank you!</strong> We've received your request and will contact you within 24 hours with your free estimate.
			</div>
		{/if}
		...
		<div class="text-center pt-4 border-t border-border">
			<p class="text-sm text-muted-foreground">
				<strong>100% Free Estimate</strong> • No obligation • Response within 24 hours<br/>
