...
<svelte:head>
  ...
  <meta
    name="description"
    content="Professional window cleaning, pressure washing, house washing & gutter cleaning services in Vancouver, Surrey, Burnaby. Free estimates & satisfaction guaranteed!"
  />
  <meta
    name="keywords"
    content="cleaning services, window cleaning, pressure washing, house washing, gutter cleaning, roof cleaning, Vancouver, Surrey, Burnaby, Richmond"
  />
...
<section class="relative py-12 md:py-16 overflow-hidden">
  ...
  <div class="relative max-w-7xl mx-auto px-[6%] text-center text-white z-10">
    <h1
      class="text-4xl md:text-6xl font-bold mb-6 font-[Helvetica] leading-tight"
    >
      Let Your Home <span class="text-primary">Shine</span>
    </h1>
    <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed">
      Professional exterior cleaning services with <strong
        >experienced teams</strong
      >, <strong>latest equipment</strong>, and
    ...
    <div class="flex flex-col sm:flex-row gap-4 justify-center mb-6">
      <Link href="/contact">
        <Button
          size="lg"
          class="bg-primary hover:bg-primary/90 text-primary-foreground font-semibold text-lg px-8 py-4 hover:scale-105 transition-all duration-300"
        >
          Get Free Estimate
        </Button>
      </Link>
    ...
    <!-- Quick Stats -->
    <div
      class="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-2xl mx-auto text-center"
    >
      <div
        class="bg-black/30 backdrop-blur-sm rounded-lg p-4 border border-white/10 hover:border-blue-400/30 transition-all duration-300 hover:scale-105"
      >
  ...
  <div class="max-w-7xl mx-auto px-[6%]">
    <div class="text-center mb-8">
      ...
      <p class="text-lg text-muted-foreground max-w-2xl mx-auto">
        Professional cleaning solutions with the latest equipment and
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {#each servicesPreviewData as service}
        ...
        >
          {#if service.popular}
            <div
              class="absolute z-10 top-4 right-4 bg-primary text-primary-foreground px-3 py-1 rounded-full text-sm font-medium w-fit animate-pulse"
            >
              Popular
            </div>
          {/if}
...
<section class="py-10 md:py-12 bg-background">
  <div class="max-w-7xl mx-auto px-[6%]">
    <div class="text-center mb-8">
      ...
      <p class="text-lg text-muted-foreground max-w-2xl mx-auto">
        Experience the remarkable difference our professional cleaning services
        make. See real transformations from our satisfied customers.
      </p>
    </div>

    <div class="space-y-8">
      <!-- House Washing Before/After -->
      <BeforeAfterComparison class="mb-8">
        {#snippet left()}
          <img
            class="select-none pointer-events-none w-full h-auto aspect-video object-cover"
            src="https://cdn.sanity.io/files/ws2fgpe5/production/1792e570b24374a784ba3db66a9a89c233a93e18.jpg?w=800&h=450&fit=crop&auto=format&q=85"
            alt="Before - House exterior cleaning transformation showing dramatic improvement"
          />
        {/snippet}
        {#snippet right()}
          <img
            class="select-none pointer-events-none w-full h-auto aspect-video object-cover"
            src="https://cdn.sanity.io/files/ws2fgpe5/production/5de4e0f59ab64d6994f54898e1ea799554c6b08f.jpg?w=800&h=450&fit=crop&auto=format&q=85"
            alt="After - House exterior cleaning transformation showing dramatic improvement"
          />
        {/snippet}
      ...
      <BeforeAfterComparison>
        {#snippet left()}
          <img
            class="select-none pointer-events-none w-full h-auto aspect-video object-cover"
            src="https://cdn.sanity.io/files/ws2fgpe5/production/4eb6bc0c0429bd9229b86dbec6aec01d8aa1e7d6.webp?w=800&h=450&fit=crop&auto=format&q=85"
            alt="Before - Roof cleaning transformation showing removal of moss, algae, and debris for improved appearance and longevity"
          />
        {/snippet}
        {#snippet right()}
          <img
            class="select-none pointer-events-none w-full h-auto aspect-video object-cover"
            src="https://cdn.sanity.io/files/ws2fgpe5/production/94f4132b51090e478da9820a1835189c20a9ae19.webp?w=800&h=450&fit=crop&auto=format&q=85"
            alt="After - Roof cleaning transformation showing removal of moss, algae, and debris for improved appearance and longevity"
          />
        {/snippet}
      </BeforeAfterComparison>
    </div>
...
<section bind:this={reviewsSection} class="py-10 md:py-12 bg-background">
  <div class="max-w-7xl mx-auto px-[6%]">
    <div class="text-center mb-8">
      ...
      <p class="text-lg text-muted-foreground max-w-2xl mx-auto">
        See what your neighbors are saying about our professional cleaning
        services
      </p>
    </div>
...
<section class="py-10 md:py-12 bg-primary/3">
  <div class="max-w-7xl mx-auto px-[6%]">
    <div class="text-center mb-10">
      ...
      <p class="text-lg text-muted-foreground max-w-2xl mx-auto">
        From estimate to completion, we make professional cleaning effortless
        for you
      </p>
    </div>
    ...
    <div class="relative">
      ...
      <div
        class="hidden md:block absolute top-24 left-1/4 right-1/4 h-1 bg-blue-100/20 rounded-full"
      >
        <div
          ...
          {#each homepageData.process as step, index}
            ...
            <div class="relative text-center group">
              ...
              {#if index < homepageData.process.length - 1}
                <div
                  class="md:hidden absolute left-1/2 -bottom-6 w-0.5 h-12 bg-blue-200/30 transform -translate-x-1/2"
                ></div>
              {/if}

              <!-- Floating background circle -->
              <div
                class="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-32 bg-blue-500/5 rounded-full blur-2xl group-hover:scale-125 transition-all duration-500"
              ></div>

              <!-- Main step container -->
              <div
                class="relative bg-card/80 backdrop-blur-sm border border-border/50 rounded-2xl p-8 hover:shadow-2xl hover:border-blue-200/50 transition-all duration-500 group-hover:-translate-y-2"
              >
                <!-- Step icon circle -->
                <div
                ...
                >
                  ...
                  <!-- Step number badge -->
                  <div
                    class="absolute -top-3 -right-3 w-8 h-8 bg-white text-primary rounded-full flex items-center justify-center text-sm font-bold shadow-lg border-2 border-blue-100/50 group-hover:scale-125 transition-all duration-300"
                  >
                    {step.step}
                  </div>
                  ...
                  <!-- Glow effect -->
                  <div
                    class="absolute inset-0 rounded-2xl bg-blue-400/10 blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10"
                  ></div>
                </div>

                <div class="space-y-4">
                  <h3
                    class="text-xl font-bold text-foreground font-[Helvetica] group-hover:text-primary transition-colors duration-300"
                  >
                    {step.title}
                  </h3>
                  ...
                  <div
                    class="mt-6 p-4 bg-blue-50/30 border-l-3 border-blue-400/40 rounded-r-lg"
                  >
                    <p
                      class="text-sm text-muted-foreground/90 leading-relaxed italic"
                    >
                      {step.details}
                    </p>
                  </div>
    ...
    <div class="text-center mt-10">
      ...
      >
        ...
        <p class="text-muted-foreground max-w-md">
          Join hundreds of satisfied customers who trust us for their cleaning
          needs
        </p>
        <Link href="/contact">
          <Button
...
<section class="py-10 md:py-12 bg-background">
  <div class="max-w-5xl mx-auto md:px-[6%]">
    <div class="text-center mb-8">
      ...
      <p class="text-lg text-muted-foreground max-w-2xl mx-auto">
        Get your free, comprehensive estimate in under 2 minutes. No hidden
        fees, no pressure.
      </p>
    </div>
...
<section class="py-10 bg-background">
  <div class="max-w-7xl mx-auto px-[6%]">
    <div class="text-center mb-8">
      ...
      <p class="text-lg text-muted-foreground max-w-2xl mx-auto">
        Find specialized cleaning services in your area with local expertise and
        guaranteed results
      </p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {#each serviceLocationsData as serviceLocation}
        <div
          class="bg-card rounded-lg border p-6 hover:shadow-lg hover:border-blue-200/30 transition-all duration-200 group"
        >
          <div class="flex items-center justify-between mb-3">
            <h3
              class="font-semibold text-lg text-foreground group-hover:text-primary transition-colors duration-300"
            >
              {serviceLocation.title}
            </h3>
            <svg
              class="w-5 h-5 text-muted-foreground group-hover:text-blue-500 group-hover:translate-x-1 transition-all duration-300"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <Link
            href={serviceLocation.href}
            class="text-primary hover:text-blue-600 font-medium text-sm transition-colors duration-300"
          >
            Get {serviceLocation.location}
    ...
    <div class="text-center mt-8">
      <p class="text-muted-foreground mb-6">
        Can't find your area? We serve all of Metro Vancouver and the Fraser
        Valley.
      </p>
      <Link href="/locations">
